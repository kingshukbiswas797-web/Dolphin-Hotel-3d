...
export default function Home() {
  return (
    <PageTransition>
      <section className="relative min-h-screen w-full bg-[#FF0000] flex flex-col z-10 font-manrope">
        {/* Outer wrapper */}
        <div className="flex-1 flex flex-col items-center w-full pt-[100px] md:pt-[200px]">
          {/* Inner container */}
          <div className="flex flex-col items-center w-full px-8 text-center z-20 relative max-w-[900px] h-auto mx-auto">
            ...
            {/* Mission statement */}
            <p className="text-white text-[16px] w-full max-w-[400px] leading-[1.6] mb-[40px] uppercase tracking-wider mx-auto">
